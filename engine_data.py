...
ABILITIES = {
    ...
    "Volley": {"kind": "channel", "school": "arcane", "cost": 490, "cast": 6.0, "cooldown": 60, "tick": 80, "ticks": 6, "coeff": 0.056, "ranged_cast": True, "aoe": True,
               "provisional": "Rank 3 (level 58) values sourced from WoWSims Classic (sim/hunter/volley.go), a baseline Classic-era spell Forever doesn't appear to have redesigned. Each tick applies to every target within range; approximated as a flat multiplier by the chosen target count."},
    ...
    "Arcane Explosion": {"kind": "direct", "school": "arcane", "cost": 390, "base": (249, 270), "coeff": 0.143, "aoe": True,
                          "provisional": "Rank 6 (level 60) values sourced from WoWSims Classic (sim/mage/arcane_explosion.go), a baseline Classic-era spell Forever doesn't appear to have redesigned. Damage applies once per target within range; this sim approximates that as a flat multiplier by the chosen target count rather than a real positional radius check."},
    "Blizzard": {"kind": "channel", "school": "frost", "cost": 1400, "cast": 8.0, "tick": 149, "ticks": 8, "coeff": 0.042, "aoe": True,
                 "provisional": "Rank 6 (level 60) values sourced from WoWSims Classic (sim/mage/blizzard.go), a baseline Classic-era spell Forever doesn't appear to have redesigned. Each tick applies to every target within range; approximated as a flat multiplier by the chosen target count."},
...
ROTATIONS = {
    ...
    "warlock-affliction": [("Rain of Fire", "targets>=3"), ("Life Tap", "mana<400"), ("Curse of Agony", "dot_missing"), ("Corruption", "dot_missing"), ("Siphon Life", "dot_missing"), ("Drain Soul", "execute and dot:Corruption>0"), ("Shadow Bolt", "true")],
