...
import init, { set_catalog, run_spec_iterations, finalize_spec, run_paladin_iterations, finalize_paladin, engine_version } from "./engine/forever_engine.js?v=e3fc2f8";

const ENGINE_WASM = "/engine/forever_engine_bg.wasm?v=e3fc2f8";
const CATALOG_FILES = ["/data/items.json?v=e3fc2f8", "/data/engine-items-extra.json?v=e3fc2f8", "/data/enchants.json?v=e3fc2f8", "/data/forever-sets.json?v=e3fc2f8"];
let ready = null;
