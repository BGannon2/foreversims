...
import init, { set_catalog, run_spec_iterations, finalize_spec, run_paladin_iterations, finalize_paladin, engine_version } from "./engine/forever_engine.js?v=42f0bb7";

const ENGINE_WASM = "/engine/forever_engine_bg.wasm?v=42f0bb7";
const CATALOG_FILES = ["/data/items.json?v=42f0bb7", "/data/engine-items-extra.json?v=42f0bb7", "/data/enchants.json?v=42f0bb7", "/data/forever-sets.json?v=42f0bb7"];
let ready = null;
