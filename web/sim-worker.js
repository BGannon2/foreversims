...
import init, { set_catalog, run_spec_iterations, finalize_spec, run_paladin_iterations, finalize_paladin, engine_version } from "./engine/forever_engine.js?v=83568ce";

const ENGINE_WASM = "/engine/forever_engine_bg.wasm?v=83568ce";
const CATALOG_FILES = ["/data/items.json", "/data/engine-items-extra.json", "/data/enchants.json", "/data/forever-sets.json"];
let ready = null;
